...
<template>
  ...
  <header v-if="authStore.token" class=" w-screen  lg:w-[300px] xl:w-[300px] h-screen lg:pb-3 xl:pb-2  lg:block xl:block hidden">
...
<span class="bg-white h-[73px] flex mx- border-b border-r"> 
  <div class="flex mx-[60px] ">
      ...
      <div class="mt-6">
        <h6 class="text-blue-600 text-sm font-bold px-4">Settings</h6>
        <ul class="mt-3">
          <li>
