...
const logout = () => {
  authStore.clearToken(); // Clear the token when logging out
  location.reload();
};
...
<template>
  ...
  <header v-if="authStore.token">
    <nav class="bg-white shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto z-20 lg:block xl:block hidden">
      ...
      <ul class="mt-6">
        <li>
          <a href="javascript:void(0)"
            ...
            <span><RouterLink to="/">Dashboard</RouterLink></span>
          </a>
        </li>
      </ul>
        ...
        <ul class="mt-3">
          ...
          <li>
            <a href="javascript:void(0)"
              ...
              <span><RouterLink to="/schedule">Schedule</RouterLink></span>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)"
